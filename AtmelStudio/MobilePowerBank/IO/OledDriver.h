...
#define OLED_OUT PORTE.OUT

#define OLED_INIT_PORTS		PORTD.DIRSET = PIN2_bm | PIN3_bm | PIN4_bm | PIN5_bm | PIN6_bm; PORTE.DIRSET = 0xff;

#define OLED_RESET_HIGH		PORTD.OUTSET = PIN5_bm;
#define OLED_RESET_LOW		PORTD.OUTCLR = PIN5_bm;

#define OLED_W_HIGH			PORTD.OUTSET = PIN6_bm;
#define OLED_W_LOW			PORTD.OUTCLR = PIN6_bm;

#define OLED_DATA			PORTD.OUTSET = PIN3_bm;
#define OLED_COMMAND		PORTD.OUTCLR = PIN3_bm;

#define OLED_CHIP_DISABLE	PORTD.OUTSET = PIN2_bm;
#define OLED_CHIP_SELECT	PORTD.OUTCLR = PIN2_bm;

#define OLED_RD_HIGH		PORTD.OUTSET = PIN4_bm;
#define OLED_RD_LOW			PORTD.OUTCLR = PIN4_bm;
